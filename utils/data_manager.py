...
# def data_to_list(text_file_name: str):
#
#     with open(f"/Users/david/Codings/PycharmProjects/KreamHarvester/datas/{text_file_name}.txt", 'r') as f:
#         data = f.read()
#         data_list = data.splitlines()
#         data_list = data_list[1:]
#     return data_list
#
# def data_to_dictionary(text_file_name: str, slicing_words):
#     with open(f"/Users/david/Codings/PycharmProjects/KreamHarvester/datas/{text_file_name}.txt", 'r') as f:
#         data = f.read()
#         data_list = data.splitlines()
#         data_list = data_list[1:]
...
#     with open(f"/Users/david/Codings/PycharmProjects/KreamHarvester/constants/{json_file_name}.json", 'w', encoding='utf-8') as json_file:
#         json.dump(list, json_file, ensure_ascii=False)
#
# def json_to_list(json_file_name):
#     with open(f"/Users/david/Codings/PycharmProjects/KreamHarvester/constants/{json_file_name}.json", 'r',encoding='utf-8') as json_file:
...
#
# def json_to_dictionary(json_file_name):
#     with open(f"/Users/david/Codings/PycharmProjects/KreamHarvester/constants/{json_file_name}.json", 'r', encoding='utf-8') as json_file:
